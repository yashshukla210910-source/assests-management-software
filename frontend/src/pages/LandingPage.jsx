      ...
      <header className="fixed top-0 left-0 right-0 z-50 transition-all duration-300 backdrop-blur-md bg-white/60 border-b border-white/20 shadow-sm">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-blue-600 to-indigo-700 flex items-center justify-center shadow-lg shadow-blue-500/30 text-white">
            ...
            <span className="text-2xl font-extrabold tracking-tight text-slate-800">
              Decentra<span className="text-blue-600">Vault</span>
            </span>
          </div>
        ...
        <section id="features" className="max-w-7xl mx-auto px-6 py-24">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-slate-600 leading-relaxed">
              DecentraVault provides the cryptographic guarantees required by regulators without sacrificing the performance needed for high-frequency operations.
            </p>
          </div>
      ...
      <footer className="relative z-10 bg-slate-900 text-slate-400 py-12 border-t border-slate-800">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex items-center gap-3">
            ...
            <span className="text-xl font-bold text-white">DecentraVault</span>
          </div>
          <p className="text-sm">© 2024 DecentraVault Institutional Systems Inc. All rights reserved.</p>
